...
Expected Behavior
When the seeds.sql file is executed in PostgreSQL Shell, the data should 
populate my table.

Actual Behavior
When the seeds.sql file is executed, the data is not successfully populated in 
the table.
...
Q: How can you alter an existing table?
A: You can use the ALTER TABLE statement to add, delete, or modify columns in 
   an existing table including constraints.
