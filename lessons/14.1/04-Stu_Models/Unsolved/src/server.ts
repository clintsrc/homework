...
Run npm run build then npm start from the command line to start the server and sync the database.
...
Try to run \d book; to describe the book table. It will fail because the table name is Book.
