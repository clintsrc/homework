...
node index.js sum 3 4 > /dev/null 2>&1
echo *** Expect difference 3 4 = -1:
node index.js difference 3 4 > /dev/null 2>&1
echo *** Expect product 3 4 = 12:
node index.js product 3 4 > /dev/null 2>&1
echo *** Expect quotient 3 4 = 0.75:
node index.js quotient 3 4 > /dev/null 2>&1
