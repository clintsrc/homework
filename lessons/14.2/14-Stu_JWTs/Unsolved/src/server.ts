 ...
 * As a business owner, I want my website to include session information, so that 
 * users cannot stay logged in forever.
 * 
 * Acceptance Criteria
 ...
 * 
 * 🏆 Bonus
 * Q: What are the pros and cons of using JWTs?
 * A: TODO
 * 
 */
