 ...
 * It's done when the JWT can be decoded to access the user information stored in the 
 *  token.
 * It's done when the user information stored in the JWT can be accessed in a React 
 *  component.
 * 
 * 📝 Notes
 ...
 * 
 * 🏆 Bonus
 * Q: What are some alternatives to using JWTs?
 * A: TODO
 * 
 */
