 ...
 *    As a user, I want to be able to toggle between light and dark themes so that 
 *    I can customize the app's appearance based on my preference.
 * 
 * Acceptance Criteria
 *    - It's done when the application initially uses a light theme.
 *    - It's done when I click on the Toggle Theme button and the application theme 
